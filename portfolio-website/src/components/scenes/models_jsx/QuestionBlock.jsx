...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/models/QuestionBlock/QuestionBlock-transformed.glb')
  ...
  return (
    <group ref={blockDispRef} {...props} dispose={null} scale={0.003} position={[0,-1.3,0]}>
