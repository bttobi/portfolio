...
const Projects = () => {
  ...
  return (
      <div id="projects" style={{height: "100vh", width: "100%"}} className="article mt-16 pb-16 shadow-top-bottom shadow-black" >
        ...
        <div className="projects-wrapper w-full h-2/3 flex lg:flex-row flex-col items-center justify-center mt-16 lg:mt-16 pb-16">
