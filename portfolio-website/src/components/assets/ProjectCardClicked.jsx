      ...
      <label htmlFor={projectInfo.id} className="modal cursor-pointer">
        <label className="modal-box h-min bg-gradient-to-r from-cyan-600 to-cyan-400">
          ...
          <div className="button-wrapper flex align-center items-center justify-around">
            <a href={projectInfo.demo_url} className="modal-action btn border-none font-bold p-3 rounded-lg w-min text-white" target="_blank">
              Demo
            </a>
            <a href={projectInfo.github_url} className="modal-action btn border-none font-bold p-3 rounded-lg w-min text-white" target="_blank">
              Github
            </a>
          </div>} 
        </label>
