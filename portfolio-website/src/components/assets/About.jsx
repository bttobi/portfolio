...
const About = () => {
  return (
    <div className="mockup-code order-2 lg:order-1 text-white text-xl mt-8 sm:text-2xl flex flex-col mx-12 w-2/3 lg:w-1/2 shadow-lg shadow-black" style={{backgroundColor: "#222831"}}>
