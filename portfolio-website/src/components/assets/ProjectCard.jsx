...
const ProjectCard = ({projectInfo}) => {
  return (
    <>
      <label aria-label="Open project details" htmlFor={projectInfo.id} className="btn shadow-lg hover:scale-105 shadow-black border-none w-1/4 h-1/3 mt-10 lg:w-1/6 lg:h-3/4 flex flex-col p-0 mx-0 lg:mx-8 xl:mx-16 justify-start bg-gradient-to-r from-cyan-600 to-cyan-400 text-white z-10">
