...
const Navbar = () => {
  return (
    <nav className="navbar backdrop-blur-sm bg-white/5 flex flex-row align-center justify-start fixed m-0 p-0 text-white w-full h-10 z-20 text-3xl">
      ...
      <div className="navlinks-wrapper h-full flex flex-row w-full justify-around">
        ...
        <a href="#contact" className="contacts-link">CONTACT</a>
      </div>
    </nav>
  )
}
