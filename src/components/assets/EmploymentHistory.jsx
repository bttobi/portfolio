      ...
      <label htmlFor="employment-history" className="modal cursor-pointer">
        <label className="modal-box h-min w-auto mx-4 bg-gradient-to-r from-cyan-600 to-cyan-400">
          ...
          <ul className="flex flex-col justify-center align-center items-center mt-2 mb-2 w-auto">
            <p className="text-xl text-center text-white font-article">
              For more information click
            </p>
            {workHistory.map((el, index) => (
              <li
                key={index}
                className="employment-history-item rounded-lg pt-2 font-bold px-4 w-auto h-min bg-white border-0 mt-4 transition-all duration-150 hover:bg-slate-200 active:scale-95 active:bg-blue-light font-article shadow-md shadow-blue-dark"
              >
