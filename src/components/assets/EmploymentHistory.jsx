      ...
      <input type="checkbox" className="modal-toggle" id="employment-history" />
        <label htmlFor="employment-history" className="modal cursor-pointer">
          <label className="modal-box h-min w-auto mx-4 bg-gradient-to-r from-cyan-600 to-cyan-400">
            ...
            <p className="text-xl text-center text-black">For more information visit my <a className="linkedin-link underline" href="https://www.linkedin.com/in/bartosz-tobinski/" target="_blank">LinkedIn</a></p>
              {workHistory.map((el, index)=>
              <li key={index} className="employment-history-item rounded-lg pt-2 font-bold px-4 w-auto h-min bg-white border-0 mt-4 transition-all duration-150 hover:bg-slate-200 active:scale-95 active:bg-blue-light">
                <button className="font-primary" aria-label="Go to LinkedIn">
                  <a className="flex flex-col justify-center items-center font-primary" href="https://www.linkedin.com/in/bartosz-tobinski/" target="_blank">
                    ...
                    <p className="py-2 text-center text-black">{el.date}</p>
                  </a>
                </button>
              </li>
              )}
