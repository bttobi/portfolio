...
export default function HelloText(props) {
  const { nodes, materials } = useGLTF(
    "/models/HelloModel/HelloText-transformed.glb",
  );

  const helloSceneRef = useRef();

  useFrame(() => {
    helloSceneRef?.current?.rotateY(0.002);
  });
